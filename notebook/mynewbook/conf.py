...
copyright = '2023'
exclude_patterns = ['**.ipynb_checkpoints', '**/.ipynb_checkpoints', '**/.venv', '**/sphinxcontrib/mermaid.py', '.DS_Store', '.venv', 'Thumbs.db', '_build']
extensions = ['sphinx_togglebutton', 'sphinx_copybutton', 'myst_nb', 'jupyter_book', 'sphinx_thebe', 'sphinx_comments', 'sphinx_external_toc', 'sphinx.ext.intersphinx', 'sphinx_design', 'sphinx_book_theme', 'sphinx_proof', 'sphinxcontrib.mermaid', 'sphinxcontrib.bibtex', 'sphinx_jupyterbook_latex']
